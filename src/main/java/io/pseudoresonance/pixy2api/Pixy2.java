package io.pseudoresonance.pixy2api;

import java.awt.Color;
import java.util.concurrent.TimeUnit;

import io.pseudoresonance.pixy2api.links.I2CLink;
import io.pseudoresonance.pixy2api.links.Link;
import io.pseudoresonance.pixy2api.links.SPILink;
import io.pseudoresonance.pixy2api.links.UARTLink;
...
public class Pixy2 {
	...
	protected int receivePacket() {
		int csSerial, res;
		io.pseudoresonance.pixy2api.Pixy2.Checksum csCalc = new Checksum();
